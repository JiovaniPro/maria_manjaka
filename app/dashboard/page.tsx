...
//           <div>
//             <p className="text-sm text-black/60">Bonjour,</p>
//             <h1 className="text-4xl font-bold">Bienvenue sur la plateforme</h1>
//           </div>
...
//           <div>
//             <h2 className="text-2xl font-semibold">Tableau de Bord Financier</h2>
//           </div>
