    ...
    <div className="flex min-h-screen items-center justify-center bg-black font-sans text-white dark:bg-black">
      <div className="flex flex-col items-center gap-6 text-center">
        <h1 className="typewriter text-4xl font-extrabold tracking-wide">
          <span>Bienvenue sur la plateforme de gestion des caisses</span>
        </h1>
        <p className="text-2xl">"Ny fitiavako ny tranonao no maharitra ny aiko"</p> <i className="text-xl">Joany 2:17</i>
        <Link
          href="/connexion"
